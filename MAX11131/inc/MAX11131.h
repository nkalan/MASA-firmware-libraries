 ...
 * 		the 'NUM_CHANNELS' variable to 1, and the first index in the 'MAX11131_CHANNELS'
 * 		array to the desired channel to read from. 
 * 	2. To read the set channel, simply call read_adc. To read from another channel,
 * 		repeat step 1 for the next channel.
 * 
...
#define SET_MAX11131_AVGON 		(uint16_t) 0x0200 // 0b10 00000000preceded by 0s
#define SET_MAX11131_ECHO_ON	(uint16_t) 0x0004 // 0b0100		  preceded by 0s
