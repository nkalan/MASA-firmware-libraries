...
class TelemParse:
	...
	def __init__(self):
		...
		self.items[14] = 'main_cycle_time' 
		self.items[15] = 'motor_cycle_time' 
	...
	def parse_packet(self, packet):
		self.dict[self.items[0]] = int((float(struct.unpack("<I", packet[0:1])[0]))/1)
		...
		self.dict[self.items[47]] = int((float(struct.unpack("<L", packet[79:87])[0]))/1)
