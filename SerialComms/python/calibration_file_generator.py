...
def main():
    ...
    # default
    output_file_parser_name = "CalibrationParse"
    output_file = "./calibrationParse.py"
    ...
    for i in range(len(calibration_parameters.index)):
        ...
        '''
        LEAVING THIS OUT FOR NOW, ASK NATHANIEL

        # If the template csv says to give a variable a different name in the gui parser, do it here
