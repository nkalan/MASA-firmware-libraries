...
def main():
    ...
    with open("../../../Inc/pack_telem_defines.h") as pack_telem_h:
        pack_telem_h_user_section_found = False
        pack_telem_h_user_section_complete = False
        for line in pack_telem_h:
            line = line.strip()
            if line == end_user_tag:
                pack_telem_h_user_section_complete = True
            if pack_telem_h_user_section_found and not pack_telem_h_user_section_complete:
    ...
    pack_telem_defines_h_string = "/// " + begin_autogen_tag + "\n/// pack_telem_defines.h\n" + \
                                ...
                                "#include \"globals.h\"\n" + \
                                "#include <stdint.h>\n\n"
    pack_telem_defines_h_string += begin_user_tag + "\n" + pack_telem_h_user_string + end_user_tag + "\n\n"
