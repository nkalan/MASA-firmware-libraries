...
def main():
    ...
    begin_user_tag = "// USER CODE BEGIN - MODIFICATIONS OUTSIDE THIS SECTION WILL BE DELETED\n"
    end_user_tag = "// USER CODE END - MODIFICATIONS OUTSIDE THIS SECTION WILL BE DELETED\n"
    ...
    # Read pack_telem_defines.h and store the user-written section
    pack_telem_h_user_string = ""
    with open("../../../Inc/pack_telem_defines.h", "r") as pack_telem_h:
        pack_telem_h_user_section_found = False
        pack_telem_h_user_section_complete = False
        for line in pack_telem_h:
            if line == begin_user_tag:
                pack_telem_h_user_section_found = True
            elif pack_telem_h_user_section_found and not pack_telem_h_user_section_complete:
                pack_telem_h_user_string += line
            elif line == end_user_tag:
                pack_telem_h_user_section_complete = True
    ...
    pack_telem_defines_h_string = "/// " + begin_autogen_tag + "\n/// pack_telem_defines.h\n" + \
                                ...
                                "#include \"globals.h\"\n" + \
                                "#include <stdint.h>\n\n"
    pack_telem_defines_h_string += begin_user_tag + pack_telem_h_user_string + end_user_tag + "\n"
