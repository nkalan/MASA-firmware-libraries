...
4. If you plan using a variable to keep of board state, make sure to select the STATES line in the `telem_data_template.csv` file and copy and paste this defintion into the user section of the autogenerated file `globals.h`
