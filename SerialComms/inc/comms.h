...
enum CLB_send_data_errors { CLB_nominal = 0, CLB_flash_buffer_overflow = 1 };
...
/**
 *  Stuff, using COBS
 *https://en.wikipedia.org/wiki/Consistent_Overhead_Byte_Stuffing, an ustuffed
 *packet in preperation for transmission
 *
 *  @param unstuffed	Pointer to unstuffed populated array
 *  @param stuffed		Pointer to unpolulated array that will be
 *stuffed
...
/**
 *  Unstuff, assuming COBS
 *https://en.wikipedia.org/wiki/Consistent_Overhead_Byte_Stuffing, an stuffed
